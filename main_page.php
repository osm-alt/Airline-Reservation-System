...
<body>
  <main>
    ...
    <!-- hero -->
    <h1 style="margin-top: 2rem; text-align: center;"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="20"
        fill="currentColor" class="bi bi-airplane-engines-fill" viewBox="0 0 16 16">
        <path
      ...
      </svg>Welcome <?php echo "$value" ?> To ROA Airlines! <svg xmlns="http://www.w3.org/2000/svg" width="16" height="20" fill="currentColor"
